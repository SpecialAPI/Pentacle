...
namespace Pentacle.Builders
{
    ...
    public static class AbilityBuilder
    {
        ...
        /// <param name="spriteName">The name of the sprite image in the project files. You can also give it a full file path if you replace all "/" with "."<para />.png extension is optional.</param>
        /// <param name="profile">Your mod profile.</param>
