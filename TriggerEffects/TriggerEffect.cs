...
namespace Pentacle.TriggerEffects
{
    ...
    public abstract class TriggerEffect
    {
        ...
        public abstract void DoEffect(IUnit sender, object args, TriggerEffectInfo triggerInfo, TriggerEffectActivationExtraInfo extraInfo);
        ...
        /// <para>This can be used for trigger effects that either delay the activation display or only trigger it under certain conditions. The trigger effect can manually show the acticvation by using <see cref="TriggerEffectActivationExtraInfo.TryGetPopupUIAction"/>. Note that this doesn't automatically check for <see cref="TriggerEffectInfo.doesPopup"/>.</para>
        /// </summary>
